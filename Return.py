...
# -*- coding: utf-8 -*-
"""
Created on Sat May 29 16:08:11 2021
...
# plt.legend(loc = 2)
# #plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/results/VIXR through time.png', bbox_inches = 'tight')

# #vix_plot.to_csv('/Users/johannesthellmann/Desktop/return.csv', index=False)
...
# #df_daily.to_csv('/Users/johannesthellmann/Desktop/vixr_daily.csv', index=False)
