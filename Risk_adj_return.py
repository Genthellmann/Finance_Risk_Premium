...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 14 18:36:13 2021
...
path1 = '/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/data/csv/LS_TradingStrategy.csv'
...
path3 = '/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/data/csv/F-F_Research_Data_5_Factors_2x3_daily.csv'
ff = pd.read_csv(path3, delimiter=',', decimal='.')
ff['INDEX'] = ff['Dates']
ff = ff.set_index(ff['INDEX'])
ff = ff.drop(['INDEX'], axis=1)
ff['Dates_FF'] = pd.to_datetime(ff['Dates'])
