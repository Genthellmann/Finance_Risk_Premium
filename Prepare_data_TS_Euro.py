...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 25 17:06:09 2021
...
data = "/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/data/EuroStoxx.xlsx"
...
#initial values 
last_day_month = pd.to_datetime("2009-12-01") #Hier anders, da davor keine Aufzeichnungen
month_counter = -1
#first col
firstcol =0
#lastcol
...
for y in year:
    ...
    for sheet in sheets:
        try:
            ...
            df_name = pd.read_excel(data, sheet_name=sheet,header = 5, usecols=ncol)
            ...
            #print(str(last_day_month))
             ...
             #Entferne hier nicht letzte beiden Tage, da für Trading Strategien benötigt
            ...
            print('cols are empty: ' + sheet + ' ' + y)
            last_day_month = pd.to_datetime("2009-12-01")
            print(last_day_month)
...
# vix_f = vix_f.sort_values(by = 'Dates')
# vix_f.to_csv('/Users/johannesthellmann/Desktop/Eurostoxx_riskadjusted_TS.csv', index=False)
