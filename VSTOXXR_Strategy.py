...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 25 16:51:46 2021
...
data_path1 = '/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/data/csv/Eurostoxx_riskadjusted_TS.csv'
#Anmerkung: Die hier verwendete ARMA.csv unterscheidet sich von der in vix_arma.py erzeugten arma.csv insofern, dass fehlerhafte Future-Werte (falsche Stelle des Dezimalpunktes)
#und das Premium für diese Werte
...
data_path2 = '/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/data/csv/vstoxx_daily.csv'
...
# Trading Positions
# ================================
res_ls = position_strategy(vixp = vix_p, start = '2009-12-03', end = '2020-06-01', strat="L/S")
...
#res_ls.to_csv('/Users/johannesthellmann/Desktop/LS_TradingStrategy_Eurostoxx.csv', index=True) #index are the dates
