...
res_lc = position_strategy(vixp = vix_p, start = '2020-02-01', end = '2020-05-21', strat = "L/C") 
res_cs = position_strategy(vixp = vix_p, start = '2020-02-01', end = '2020-05-21', strat = "C/S")    
res_ls = position_strategy(vixp = vix_p, start = '2020-02-01', end = '2020-05-21', strat = "L/S")    
res_ss = position_strategy(vixp = vix_p, start = '2020-02-01', end = '2020-05-21', strat = "S/S")    
res_ss = position_strategy(vixp = vix_p, start = '2020-02-01', end = '2020-05-21', strat = "S/S")    

#Alternative Handelsstrategien nicht von Cheng
res_ll = position_strategy(vixp = vix_p, start = '2020-02-01', end = '2020-05-21', strat = "L/L")    
res_sc = position_strategy(vixp = vix_p, start = '2020-02-01', end = '2020-05-21', strat = "S/C")    
res_sl = position_strategy(vixp = vix_p, start = '2020-02-01', end = '2020-05-21', strat = "S/L")    
res_cl = position_strategy(vixp = vix_p, start = '2020-02-01', end = '2020-05-21', strat = "C/L")    
...
#plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/Präsentation/TS_LC.png', bbox_inches = 'tight')
...
#plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/Präsentation/TS_CS.png', bbox_inches = 'tight')
...
ax.set_xticklabels(['Feb 01', 'Mar 01','Apr 01', 'May 01'])   
ax.set_ylim([-100,350])
plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/Präsentation/TSLS.pdf',bbox_inches = 'tight')
...
plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/Präsentation/TSSS.pdf', bbox_inches = 'tight')
...
#plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/results/Trading Strategies/TS_LL.png', bbox_inches = 'tight')
...
#plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/results/Trading Strategies/TS_SC.png', bbox_inches = 'tight')
...
#plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/results/Trading Strategies/TS_SL.png', bbox_inches = 'tight')
...
#plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/results/Trading Strategies/TS_CL.png', bbox_inches = 'tight')
...
plt.legend(loc=2)
#plt.savefig('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/results/Trading Strategies/TS_Uebersicht.png', bbox_inches = 'tight')
...
dates_to_use = (sp500['Dates']>=pd.to_datetime('2020-02-01'))&(sp500['Dates']<=pd.to_datetime('2020-05-21'))
...
summary = summary.append({'Mean' : np.mean(sp_excess),'SD' : np.std(sp_excess), 'Skew' : skew(sp_excess),
                           ...
                           '95%' : np.quantile(sp_excess, 0.95), 'T' : 77}, ignore_index=True)
...
#summary.to_excel('/Users/johannesthellmann/Desktop/SoSe2021/Seminar BWL/results/results_TS.xlsx', sheet_name = 'TS_SUM', index = False, float_format="%.2f")
